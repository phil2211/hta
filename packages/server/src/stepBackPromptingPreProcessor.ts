...
export function makeStepBackPromptingPreprocessor(
  ...
  const system = `You are an expert at taking a specific question and extracting a more generic question that gets at the underlying principles needed to answer the specific question.

You will be asked about drug reimbursement, Health Technology Assessment (HTA) documents, and related regulatory information, potentially referencing data retrieved from government websites.
...
But make sure to keep any key details such as specific drugs, regulations, jurisdictions, reimbursement criteria, or HTA document references from the original user query.
